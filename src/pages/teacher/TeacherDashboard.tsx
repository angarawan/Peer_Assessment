...
export const TeacherDashboard: React.FC<TeacherDashboardProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-700 rounded-3xl p-6 sm:p-8 text-white shadow-lg shadow-emerald-700/15 relative overflow-hidden">
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/20 backdrop-blur-xs text-emerald-100 text-xs font-semibold mb-3">
          ...
          <p className="mt-1 text-sm sm:text-base text-emerald-50 max-w-2xl">
          ...
          <div className="mt-5 flex flex-wrap gap-2.5">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white text-emerald-800 text-xs sm:text-sm font-bold shadow-md hover:bg-emerald-50 transition-colors"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-800/60 hover:bg-emerald-800/80 text-white text-xs sm:text-sm font-semibold backdrop-blur-xs transition-colors"
            >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
        ...
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-xs">
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-xs font-semibold text-emerald-600">Terkumpul</span>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-center gap-6 my-4">
              <div className="w-24 h-24 rounded-2xl bg-gradient-to-tr from-emerald-500 to-teal-400 text-white flex flex-col items-center justify-center shadow-lg shadow-emerald-500/20">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition-colors mt-2"
          >
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs lg:col-span-2">
          ...
          <div className="space-y-3">
            {tasks.slice(0, 2).map((t) => (
              <div
                key={t.id}
                className="p-4 rounded-2xl border border-slate-200/80 hover:border-emerald-200 bg-slate-50/50 hover:bg-emerald-50/20 transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3"
              >
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl text-xs font-bold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 shadow-2xs shrink-0"
                >
                  Lihat Hasil Masuk
                </button>
              </div>
            ...
            {assessments.slice(0, 5).map((asm) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-700 font-bold flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-500">
                      ...
                      menilai{' '}
                      <span className="font-bold text-emerald-700">{asm.targetName}</span>{' '}
                      ({asm.assessorClass})
                    </p>
